export const faqData = {
  nl: {
    ...
    subtitle: "Hieronder een FAQ, passend bij VOVON Development als combinatie van vastgoedontwikkeling, gebiedsontwikkeling, verduurzaming, energie vraagstukken, oplossingen en procesregie.",
    qas: [
      {
  ...
  en: {
    ...
    subtitle: "Below is an FAQ related to VOVON Development as a combination of real estate development, area development, sustainability, energy challenges, solutions, and process management.",
    qas: [
      {
