        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="p-6 overflow-y-auto prose prose-slate max-w-none">
              ...
              <p>
                Onze site bevat verwijzingen of hyperlinks naar andere sites die buiten het domein van ons liggen. Deze zijn opgenomen ter informatie van de gebruikers en te goeder trouw geselecteerd voor onze doelgroepen. Wij zijn niet verantwoordelijk voor de inhoud of beschikbaarheid van deze sites of bronnen. Ook geven wij geen garantie noch aanvaarden wij enigerlei aansprakelijkheid met betrekking tot de inhoud, data, adviezen, verklaringen, software, producten of ander materiaal op dergelijke sites of bronnen.
              </p>
              <p>
